...
const registerSchema = z.object({
  ...
  role: z.enum(["DOCTOR", "ADMIN_PPRA"] as const, "Pilih role terlebih dahulu"),
});

type RegisterForm = z.infer<typeof registerSchema>;
type ModalState = { open: false } | { open: true; success: true } | { open: true; success: false; message: string };
...
export default function RegisterPage() {
  ...
  async function onSubmit(data: RegisterForm) {
    ...
    try {
      ...
      setModal({ open: true, success: false, message });
    } finally {
      setIsLoading(false);
    }
  }
        ...
        >
          {modal.open && modal.success ? (
            <>
              ...
              <div className="flex flex-col gap-1">
                <p className="text-xl font-bold text-ams-black">Akun Berhasil Dibuat</p>
                <p className="text-sm text-ams-black/50">Silakan masuk untuk mulai menggunakan AMS</p>
              </div>
              <Button
            ...
            <>
              ...
              <div className="flex flex-col gap-1">
                <p className="text-xl font-bold text-ams-black">Akun Gagal Dibuat</p>
